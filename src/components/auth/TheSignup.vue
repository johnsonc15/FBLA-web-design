<template>
  <the-nav></the-nav>
  <div class="container-flex login center-h">
    <div class="center-v width">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="padding-b">
          ...
          <input type="password" class="contact-input-text" />
        </div>
        <div class="padding-c">
          <p>If you have already create an account, <router-link to="/login">click here</router-link> to login.</p>
        </div>
        <div>
